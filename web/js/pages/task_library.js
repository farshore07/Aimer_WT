...
const TaskLibrary = {
                    ...
                    <div class="skin-edit-layout">
                        <div class="skin-edit-preview-panel">
                            <div class="skin-cover-edit skin-edit-cover" onclick="TaskLibrary.request_update_cover()">
                                <img id="edit-task-cover" src="" alt="${this._t('resource.cover_preview_alt')}">
                        ...
                        <div class="skin-edit-info-panel">
                            <h2>${this._t('resource.edit_task_title')}</h2>
                            <p class="subtitle">${this._t('resource.edit_task_subtitle')}</p>
                            <div class="skin-edit-tags" aria-label="${this._t('resource.category_task')}">
                            ...
                            <div class="edit-skin-form">
                                <div class="form-group skin-edit-field">
                                    ...
                                    <div class="skin-edit-input-wrap">
                                        <input type="text" id="edit-task-display-name" maxlength="32" placeholder="${this._t('resource.display_name_placeholder')}">
                                        <span id="edit-task-display-count">0/32</span>
                                    </div>
                                </div>
                                <div class="form-group skin-edit-field">
                                    <label>${this._t('resource.original_folder_name')}</label>
                                    <input type="text" id="edit-task-name" placeholder="${this._t('resource.folder_name_placeholder')}">
                                </div>
                            </div>
                            <div class="modal-actions">
                                <button class="btn secondary" onclick="app.closeModal('modal-edit-task')">${this._t('common.cancel')}</button>
    ...
    async save_edit() {
        ...
        app.showAlert(this._t('common.success'), this._t('resource.task_info_saved'), 'success');
